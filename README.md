...
| `get_latest_signal` | 查看指定策略的最新信号 |
| `get_historical_signals` | 查看指定策略的历史信号 |
| `get_strategy_performance` | 查看指定策略的历史效果和核心指标 |
| `get_strategy_risk` | 查看指定策略的主要风险说明 |
| `get_strategy_report` | 查看指定策略的完整报告 |
